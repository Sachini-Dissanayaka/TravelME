...
class HotelsentimentdomainSpider(scrapy.Spider):
    name = 'tripadvisor'
    allowed_domains = ['hotelsentimentdomain.com']
    start_urls = ["https://www.tripadvisor.com/SmartDeals-g304138-Kandy_Kandy_District_Central_Province-Hotel-Deals.html"]
